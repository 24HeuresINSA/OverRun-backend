...
export const accessTokenTimeout = parseInt(
  String(process.env.ACCESS_TOKEN_TIMEOUT)
);
export const refreshTokenSecret = String(process.env.REFRESH_TOKEN_SECRET);
export const refreshTokenTimeout = parseInt(
  String(process.env.REFRESH_TOKEN_TIMEOUT)
);
